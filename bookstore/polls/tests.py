...
def create_question(question_text, days):
    """
    Create a question with the given 'question_text' and published on the 
    given number of 'days' offset to now (negitive for questions published in 
...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_future_question(self):
        """
        was_published_recently() returns False for questions whose pub_date is a 
        future date.
        """
